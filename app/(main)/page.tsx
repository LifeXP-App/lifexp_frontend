...
function UserStatusSkeleton() {
  return (
    <div className="bg-white dark:bg-dark-2 border-2 border-gray-200 dark:border-[var(--border)] flex p-3 rounded-xl gap-3 min-w-[200px] max-w-[250px] items-center flex-shrink-0 animate-pulse">
      <div className="p-[1.5px] rounded-full h-14 w-14 aspect-square bg-gray-200 dark:bg-[var(--dark-2)]" />

      <div className="flex flex-col justify-between w-full">
        <div className="h-4 w-32 rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-2" />
...
function PostSkeleton() {
  return (
    <div className="bg-white dark:bg-dark-2 border-2 border-gray-200 dark:border-[var(--border)] rounded-xl p-4 mb-4 animate-pulse">
      ...
      {/* Title & Content */}
      <div className="mb-3">
        <div className="h-5 w-48 rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-2" />
        <div className="h-4 w-full rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-2" />
        <div className="h-4 w-3/4 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
      </div>

      {/* Post Image */}
      <div className="h-80 w-full rounded-lg bg-gray-200 dark:bg-[var(--dark-2)] mb-4" />

      {/* XP Distribution */}
      <div className="flex gap-2 mb-4">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex-1 h-8 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
        ))}
      </div>

      {/* Actions */}
      <div className="flex items-center gap-4">
        <div className="h-8 w-16 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
        <div className="h-8 w-16 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
      </div>
    </div>
  );
    ...
    <aside className="w-full hidden md:block">
      ...
      >
        <div className="flex justify-between mb-6">
          <div className="h-4 w-44 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
          <div className="h-4 w-16 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
        </div>

        <div className="w-full flex gap-1 items-center">
          <div className="w-full rounded-full h-2.5 ml-1 bg-gray-200 dark:bg-[var(--dark-2)] overflow-hidden">
            <div className="h-2.5 w-[12%] rounded-full bg-gray-300 dark:bg-[var(--dark-3)]" />
          </div>
        </div>
      </div>
    </aside>
  ...
  return (
    <div className="bg-white w-full p-6 mb-4 rounded-xl border-2 border-gray-200 dark:bg-dark-2 dark:border-[var(--border)] animate-pulse">
      <div className="flex justify-between items-center mb-4">
        <div className="h-4 w-28 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
        <div className="h-5 w-5 rounded-full bg-gray-200 dark:bg-[var(--dark-2)]" />
      </div>
          ...
          {[1, 2].map((i) => (
            <li key={i}>
              <div className="flex gap-4">
                <div className="h-12 w-12 rounded-md bg-gray-200 dark:bg-[var(--dark-2)]" />
                <div className="flex flex-col w-full">
                  <div className="h-3 w-40 rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-2" />
                  <div className="h-3 w-24 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
                </div>
              </div>
            </li>
...
function DiscoverUsersSkeleton() {
  return (
    <div className="bg-white dark:bg-dark-3 p-6 mb-4 rounded-xl border-2 border-gray-200 dark:border-[var(--border)] animate-pulse">
      <div className="h-4 w-44 rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-4" />
      <div className="space-y-4">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-[var(--dark-2)]" />
            <div className="flex-1">
              <div className="h-3 w-32 rounded bg-gray-200 dark:bg-[var(--dark-2)] mb-2" />
              <div className="h-3 w-20 rounded bg-gray-200 dark:bg-[var(--dark-2)]" />
            </div>
          </div>
        ))}
      </div>
