...
// Django's SessionImageView rejects anything over 10MB or 40 megapixels
// (see LifeXP/api/v1/session_views.py: MAX_UPLOAD_BYTES, validate_image_upload).
...
const SANITY_CAP_BYTES = 50 * 1024 * 1024;
...
const DayCompletePage = () => {
  ...
  try {
    ...
    // Resize/re-encode client-side if needed so Django never has a reason to
    // reject it for size — the user never has to think about file size at all.
