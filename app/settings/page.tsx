  ...
  return (
    <main className="flex overflow-y-auto w-full">
      <div className="w-full md:w-[calc(100%-420px)] flex-1 overflow-y-auto py-8 px-6 md:px-12">
        <h2 className="text-2xl font-medium text-left text-black mb-6">
          Settings
        </h2>

        {/* Account type */}
        <div className="flex justify-between w-full mb-4">
          <h2 className="text-l md:text-xl font-medium text-left text-black mb-2">
            Account Type
          </h2>
          ...
          <div className="relative inline-block w-32">
            <select
              ...
              className="cursor-pointer text-sm md:text-base block appearance-none w-full bg-white border border-gray-800 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight"
            >
      ...
      <aside className="w-[420px] p-6 hidden md:block overflow-y-auto">
        <div className="bg-white p-6 mb-4 rounded-xl border-2 border-gray-200 flex flex-col gap-4">
          ...
          <Link
            href="/edit_profile"
            className="cursor-pointer text-l font-semibold text-left text-gray-800 hover:text-gray-600"
          >
            Edit Profile
          </Link>
          ...
          <button className="cursor-pointer text-l font-semibold text-left text-red-700 hover:text-red-800">
            Delete Account
          </button>
        </div>

        <div className="bg-white p-6 mb-4 rounded-xl border-2 border-gray-200 flex flex-col gap-4">
          <button className="cursor-pointer text-l font-semibold text-left text-gray-800 hover:text-gray-600">
            Invite Friends
          </button>
