  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      <div className="bg-gray-100 dark:bg-dark-3 rounded-full p-6 mb-4">
        <LockClosedIcon className="w-12 h-12 text-gray-400 dark:text-[var(--muted)]" />
      </div>
      <h3 className="text-xl font-semibold dark:text-[var(--foreground)] mb-2">
        This Account is Private
      </h3>
      <p className="text-gray-500 dark:text-[var(--muted)] text-center max-w-sm">
